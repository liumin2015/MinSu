...
public interface SearchDao {
	...
	public List<Map<String,Object>> sqlWithpagingInMysql2(@Param("sql")String sql,
			@Param("startIndex")int startIndex, @Param("pageNum")int pageNum);
	...
	public int sqlCount2(@Param("sql")String sql);
	
	public List<Map<String, Object>> executeSQL(@Param("executeSQL")String executeSQL);
}
