...
public interface WishListDao {
	...
	public int saveEntities(@Param("entities")WishList[] wishLists);
	
	public int updateByID(@Param("entity")WishList wishList, @Param("id")String ID);
	public int updateByCondition(@Param("entity")WishList wishList, @Param("condition")String condition);
	...
	public WishList getByID(@Param("ID")String ID);
	public List<WishList> getByCondition(@Param("condition")String condition);
