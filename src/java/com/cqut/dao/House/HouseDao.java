...
public interface HouseDao {
	...
	public int saveEntities(@Param("entities")House[] houses);
	
	public int updateByID(@Param("entity")House house, @Param("id")String ID);
	public int updateByCondition(@Param("entity")House house, @Param("condition")String condition);
	...
	public House getByID(@Param("ID")String ID);
	public List<House> getByCondition(@Param("condition")String condition);
