package com.cqut.dao.BookRules;
...
public interface BookRulesDao {
	public int save(BookRules bookRules);
	public int saveEntities(@Param("entities")BookRules[] bookRuless);
	
	public int updateByID(@Param("entity")BookRules bookRules, @Param("id")String ID);
	public int updateByCondition(@Param("entity")BookRules bookRules, @Param("condition")String condition);
	...
	public BookRules getByID(@Param("ID")String ID);
	public List<BookRules> getByCondition(@Param("condition")String condition);
