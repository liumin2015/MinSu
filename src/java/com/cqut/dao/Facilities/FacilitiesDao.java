package com.cqut.dao.Facilities;
...
public interface FacilitiesDao {
	public int save(Facilities facilities);
	public int saveEntities(@Param("entities")Facilities[] facilitiess);
	
	public int updateByID(@Param("entity")Facilities facilities, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Facilities facilities, @Param("condition")String condition);
	...
	public Facilities getByID(@Param("ID")String ID);
	public List<Facilities> getByCondition(@Param("condition")String condition);
