...
public interface EvaluateDao {
	...
	public int saveEntities(@Param("entities")Evaluate[] evaluates);
	
	public int updateByID(@Param("entity")Evaluate evaluate, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Evaluate evaluate, @Param("condition")String condition);
	...
	public Evaluate getByID(@Param("ID")String ID);
	public List<Evaluate> getByCondition(@Param("condition")String condition);
