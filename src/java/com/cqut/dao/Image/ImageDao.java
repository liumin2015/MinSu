...
public interface ImageDao {
	...
	public int saveEntities(@Param("entities")Image[] images);
	
	public int updateByID(@Param("entity")Image image, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Image image, @Param("condition")String condition);
	...
	public Image getByID(@Param("ID")String ID);
	public List<Image> getByCondition(@Param("condition")String condition);
