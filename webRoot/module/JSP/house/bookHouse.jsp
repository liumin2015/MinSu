...
<html lang="zh-CN">
	<head>
        ...
        <script src="module/js/travel/bookorder.js" type="text/javascript"></script>
	...
	<div class="warpper">
		...
		<img class="pay" src="" id="payimg" 
		     style="width:300px;height:300px;position: relative;left: 500px;top: 100px;
             margin-bottom: 100px;border:solid #ccc 1px" />
		<hr/>
