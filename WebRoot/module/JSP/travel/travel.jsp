...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript" src="module/js/travel/travel.js"></script>
    </head>
	<body>
	...
	<div class="warpper">
		...
		<hr/>
		<div class="main">
		<h2 class="travel">待付款的旅行</h2>
		<div class="travelbox" id="paytravel">
			<!-- <div class="travellist">
				...
				<div class="travelInd">
					...
					<button class="unsubscribe">去付款</button>
				</div>
			</div> -->
		</div>
		<h2 class="travel">即将启程的旅行</h2>
		<div class="travelbox" id="nowtravel">
			<!-- <div class="travellist">
				<img class="travelimg" src="img/house2.jpg">
				<img class="OwnerPhoto" src="img/user01.jpg">
				<div class="travelInd">
		...
		<div class="travelbox" id="pastTravel">
		<!-- <div class="travellist">
			<img class="travelimg" src="img/house2.jpg">
			<img class="OwnerPhoto" src="img/user01.jpg">
			<div class="travelInd">
