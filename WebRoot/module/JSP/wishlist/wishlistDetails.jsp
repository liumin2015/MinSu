...
<html lang="zh-CN">
	<head>
	    ...
	    <script type="text/javascript" src="module/js/wishlist/wishlistDetail.js" ></script>   
	...
	<div class="warpper">
		...
		<span class="wishNumtitle"><span class="creatTime"></span>*<span class="houseNum">2</span>个房源</span>
